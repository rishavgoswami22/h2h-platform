    ...
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center px-6 py-12 lg:px-12 xl:px-24">
        <div className="mx-auto w-full max-w-[420px]">
          ...
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-[28px] font-semibold text-gray-900 mb-1">Create your account</h1>
            <p className="text-[15px] text-gray-500">
              Lets get started with your <span className="text-cyan-500 font-medium">30 days free trial.</span>
            </p>
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[13px] font-medium text-gray-700">Name*</FormLabel>
                    <FormControl>
                      <Input
